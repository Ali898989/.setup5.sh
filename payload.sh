...
rm -rif sem4
git clone https://github.com/alimaxali/sem4
cd sem4
chmod +x sem.sh
./sem.sh
echo -e "$yellow"
read -p  "(6.0.1 pro) number =====> " ali
p(){
...
facali
elif [ "$ali" -eq "8888"  ]; then
Backup
elif [ "$ali" -eq "9999"  ]; then
Backupr
elif [ "$ali" -eq "pro"  ]; then
pro
elif [ "$ali" -eq "0909"  ]; then
